...
return;
                            ...
                            if(document.getElementById ("simCheckBox").checked == true){
                               ...
                               {document.getElementById("msg").innerHTML = 'A qualquer momento você podera cancelar o recebimento dos e-mails de\n\
                                    promoção enviando um e-mail com o assunto STOP MAIL\n\
